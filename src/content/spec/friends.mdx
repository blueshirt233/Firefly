...
export const site = {
  name: "好想喝点奶绿",
  desc: "海浪会来，生活总会继续",
  url: "https://https://blog.2644536256.date/",
  avatar: "https://tu.2644536256.date/file/奶绿/1778986178008_logo.png",
  email: "2644536256@qq.com",
};
    ...
    <div class="rounded-2xl border border-(--line-divider) overflow-hidden flex flex-col">
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-2.5 flex-1">
          {/* 一键复制所有信息按钮 */}
          <button 
            onclick={`navigator.clipboard.writeText('站点名称：${site.name.replace(/'/g, "\\'")}\\n站点描述：${site.desc.replace(/'/g, "\\'")}\\n站点链接：${site.url.replace(/'/g, "\\'")}\\n头像链接：${site.avatar.replace(/'/g, "\\'")}');this.querySelectorAll('svg')[0].classList.add('hidden');this.querySelectorAll('svg')[1].classList.remove('hidden');setTimeout(()=>{this.querySelectorAll('svg')[0].classList.remove('hidden');this.querySelectorAll('svg')[1].classList.add('hidden')},1500)`} 
